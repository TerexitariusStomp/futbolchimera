  ...
  return (
    <section id="apps" className="py-32" style={{ background: "rgba(15,45,26,0.4)" }} ref={ref}>
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-6 h-px" style={{ background: GOLD }} />
          <span className="font-['JetBrains_Mono'] text-xs tracking-[0.2em] uppercase" style={{ color: GOLD }}>Platforms</span>
        </div>
        <h2 className="font-['Barlow_Condensed'] font-black text-foreground leading-none mb-16" style={{ fontSize: "clamp(2.5rem, 5vw, 4.5rem)" }}>
          TWO PLATFORMS,<br />ONE GOAL
        </h2>
        ...
        <div className="grid md:grid-cols-2 gap-px" style={{ background: "rgba(245,200,0,0.1)" }}>
          ...
          >
            ...
            <h3 className="font-['Barlow_Condensed'] font-bold text-4xl text-foreground mb-2 uppercase tracking-wide">iOS App</h3>
            <p className="font-['DM_Sans'] text-muted-foreground text-sm mb-8 leading-relaxed">
              Built for iPhone and iPad. Native iOS project generated by Expo prebuild, bundled with on-device AI and P2P sync.
            </p>
          ...
          <div
            className="bg-card p-10"
            style={{ opacity: inView ? 1 : 0, transform: inView ? "none" : "translateX(20px)", transition: "all 0.6s ease 0.1s" }}
          >
            <div className="flex items-center gap-3 mb-8">
              <span
                className="font-['JetBrains_Mono'] text-xs px-2 py-0.5"
                style={{ color: BLUE, background: "rgba(26,90,255,0.08)", border: "1px solid rgba(26,90,255,0.3)" }}
              >
                ANDROID
              </span>
              <span className="font-['JetBrains_Mono'] text-muted-foreground text-xs">io.chimera.mobile</span>
            </div>
            <h3 className="font-['Barlow_Condensed'] font-bold text-4xl text-foreground mb-2 uppercase tracking-wide">Android App</h3>
            <p className="font-['DM_Sans'] text-muted-foreground text-sm mb-8 leading-relaxed">
              Built for Android phones and tablets. Gradle-backed native Android project with adaptive icons and splash screens.
            </p>
            <div className="grid grid-cols-2 gap-3">
              {[
                ["SDK", "Expo 52"],
                ...
                <div key={k} className="p-3" style={{ border: "1px solid rgba(26,90,255,0.12)" }}>
                  <div className="font-['JetBrains_Mono'] text-muted-foreground text-xs mb-1">{k}</div>
                  <div className="font-['DM_Sans'] text-foreground text-sm font-medium">{v}</div>
                </div>
              ))}
